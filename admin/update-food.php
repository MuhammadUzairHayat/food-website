...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        if ($stmt === false) {
            ...
            $stmt->bind_param("ssdsiiii", $title, $description, $price, $image_name, $category_id, $feature, $active, $id);
            ...
            if ($stmt->execute()) {
                ...
                $errors[] = "Error updating food item: " . $stmt->error;
            }
...
<head>
    ...
    <title>Update Food Item | Restaurant Management</title>
...
<body>
    <div class="admin-container">
        <div class="form-header">
            <h2><i class="fas fa-edit"></i> Update Food Item</h2>
            <p>Modify the details of this menu item.</p>
        </div>
        ...
        <div class="form-card">
            <form method="POST" class="food-form">
                ...
                <div class="image-upload">
                    <img src="<?php echo htmlspecialchars($food['image_name'] ?: 'https://via.placeholder.com/200x150?text=Food+Image'); ?>" 
                         alt="Food Preview" 
                         class="image-preview"
                         id="image-preview">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="text" id="title" name="title" style="padding: .5rem 2.5rem;" class="form-control"
                            ...
                            value="<?php echo htmlspecialchars($food['title']); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <textarea id="description" name="description" style="padding: .5rem 2.5rem;" class="form-control"
                            placeholder="Enter food description" required><?php echo htmlspecialchars($food['description']); ?></textarea>
                    </div>
                </div>
                        ...
                        <select id="category_id" name="category_id" style="padding: .5rem 2.5rem;" class="form-control" required>
                            ...
                            <?php foreach ($categories as $category): ?>
                                <option value="<?php echo $category['id']; ?>"
                                    <?php echo ($food['category_id'] == $category['id']) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="url" id="image_name" name="image_name" style="padding: .5rem 2.5rem;" class="form-control"
                            ...
                            value="<?php echo htmlspecialchars($food['image_name']); ?>">
                    </div>
                </div>
                    ...
                    <div class="feature-toggle">
                        <label class="toggle-switch">
                            <input type="checkbox" id="feature" name="feature" 
                                   <?php echo $food['feature'] ? 'checked' : ''; ?>>
                            <span class="slider"></span>
                        </label>
                        <span id="feature-status"><?php echo $food['feature'] ? 'Yes' : 'No'; ?></span>
                    </div>
                </div>
                    ...
                    <div class="feature-toggle">
                        <label class="toggle-switch">
                            <input type="checkbox" id="active" name="active" 
                                   <?php echo $food['active'] ? 'checked' : ''; ?>>
                            <span class="slider"></span>
                        </label>
                        <span id="active-status"><?php echo $food['active'] ? 'Yes' : 'No'; ?></span>
                    </div>
                </div>
